...
<div class="main-container" id="main-container">
	...
	<!-- 程序入口 -->
	<script>
        require(["Ace", "PDCoreDir/home/homeApp", "PDAppDir/appPath", "PDCoreDir/corePath", "PDGlobalDir/base"], function (Ace, HomeApp,loginout) {
            require(["PDLoginDir/js/loginout"], function(Loginout){
