...
echarts.define('echarts', ['echarts/echarts'], function (main) {return main;});
echarts.define('echarts/echarts', [
    'require',
    './config',
    'zrender/tool/util',
    'zrender/tool/event',
    ...
    var ecConfig = echarts.require('./config');
    var zrUtil = echarts.require('zrender/tool/util');
    var zrEvent = echarts.require('zrender/tool/event');
    var self = {};
    var _canvasSupported = echarts.require('zrender/tool/env').canvasSupported;
    ...
    self.init = function (dom, theme) {
        var zrender = echarts.require('zrender');
    ...
    var ZR_EVENT = echarts.require('zrender/config').EVENT;
    ...
    Echarts.prototype = {
        _init: function () {
            var self = this;
            var _zr = echarts.require('zrender').init(this.dom);
            this._zr = _zr;
        ...
        _eventPackage: function (target) {
            if (target) {
                var ecData = echarts.require('./util/ecData');
        ...
        _render: function (magicOption) {
            ...
            this._chartList = [];
            var chartLibrary = echarts.require('./chart');
            var componentLibrary = echarts.require('./component');
        ...
        _mergeGlobalConifg: function (magicOption) {
            ...
            this._zr.getColor = function (idx) {
                var zrColor = echarts.require('zrender/tool/color');
        ...
        _setTimelineOption: function (option) {
            ...
            var Timeline = echarts.require('./component/timeline');
        ...
        getConnectedDataURL: function (imgType) {
            ...
            var zrImg = echarts.require('zrender').init(zrDom);
            var ImageShape = echarts.require('zrender/shape/Image');
        ...
        showLoading: function (loadingOption) {
            var effectList = {
                bar: echarts.require('zrender/loadingEffect/Bar'),
                bubble: echarts.require('zrender/loadingEffect/Bubble'),
                dynamicLine: echarts.require('zrender/loadingEffect/DynamicLine'),
                ring: echarts.require('zrender/loadingEffect/Ring'),
                spin: echarts.require('zrender/loadingEffect/Spin'),
                whirling: echarts.require('zrender/loadingEffect/Whirling')
            };
        ...
        setTheme: function (theme) {
            if (theme) {
                if (typeof theme === 'string') {
                    switch (theme) {
                    default:
                        theme = echarts.require('./theme/default');
                    }
                } else {
                    theme = theme || {};
                }
    ...
    return self;
});echarts.define('echarts/config', [], function () {
    var config = {
    ...
    return config;
});echarts.define('zrender/tool/util', [
    'require',
    '../dep/excanvas'
], function (require) {
    var BUILTIN_OBJECT = {
...
});echarts.define('zrender/tool/event', [
    'require',
    '../mixin/Eventful'
], function (require) {
    'use strict';
    var Eventful = echarts.require('../mixin/Eventful');
    function getX(e) {
...
});echarts.define('zrender/tool/env', [], function () {
    function detect(ua) {
        var os = this.os = {};
...
});echarts.define('zrender', ['zrender/zrender'], function (main) {return main;});
echarts.define('zrender/zrender', [
    'require',
    './dep/excanvas',
    './tool/util',
    './tool/log',
    ...
    echarts.require('./dep/excanvas');
    var util = echarts.require('./tool/util');
    var log = echarts.require('./tool/log');
    var guid = echarts.require('./tool/guid');
    var Handler = echarts.require('./Handler');
    var Painter = echarts.require('./Painter');
    var Storage = echarts.require('./Storage');
    var Animation = echarts.require('./animation/Animation');
    var _instances = {};
    var zrender = {};
    ...
    var ZRender = function (id, dom) {
        this.id = id;
        this.env = echarts.require('./tool/env');
    ...
    return zrender;
});echarts.define('zrender/config', [], function () {
    var config = {
        EVENT: {
            RESIZE: 'resize',
            CLICK: 'click',
    ...
    return config;
});echarts.define('echarts/chart/island', [
    'require',
    '../component/base',
    './base',
    ...
    var ComponentBase = echarts.require('../component/base');
    var ChartBase = echarts.require('./base');
    var CircleShape = echarts.require('zrender/shape/Circle');
    var ecConfig = echarts.require('../config');
    var ecData = echarts.require('../util/ecData');
    var zrUtil = echarts.require('zrender/tool/util');
    var zrEvent = echarts.require('zrender/tool/event');
    ...
    Island.prototype = {
        ...
        _combine: function (tarShape, srcShape) {
            var zrColor = echarts.require('zrender/tool/color');
            var accMath = echarts.require('../util/accMath');
    ...
    echarts.require('../chart').define('island', Island);
    return Island;
});echarts.define('echarts/component/toolbox', [
    'require',
    './base',
    'zrender/shape/Line',
    'zrender/shape/Image',
    ...
    var Base = echarts.require('./base');
    var LineShape = echarts.require('zrender/shape/Line');
    var ImageShape = echarts.require('zrender/shape/Image');
    var RectangleShape = echarts.require('zrender/shape/Rectangle');
    var IconShape = echarts.require('../util/shape/Icon');
    var ecConfig = echarts.require('../config');
    var zrUtil = echarts.require('zrender/tool/util');
    var zrConfig = echarts.require('zrender/config');
    var zrEvent = echarts.require('zrender/tool/event');
    ...
    Toolbox.prototype = {
        ...
        _buildItem: function () {
            ...
            for (var i = 0; i < iconLength; i++) {
                ...
                case 'dataView':
                    if (!this._dataView) {
                        var DataView = echarts.require('./dataView');
    ...
    echarts.require('../component').define('toolbox', Toolbox);
    return Toolbox;
});echarts.define('echarts/component', [], function () {
    var self = {};
    ...
    return self;
});echarts.define('echarts/component/title', [
    'require',
    './base',
    'zrender/shape/Text',
    'zrender/shape/Rectangle',
    ...
    var Base = echarts.require('./base');
    var TextShape = echarts.require('zrender/shape/Text');
    var RectangleShape = echarts.require('zrender/shape/Rectangle');
    var ecConfig = echarts.require('../config');
    var zrUtil = echarts.require('zrender/tool/util');
    var zrArea = echarts.require('zrender/tool/area');
    var zrColor = echarts.require('zrender/tool/color');
    ...
    echarts.require('../component').define('title', Title);
    return Title;
});echarts.define('echarts/component/tooltip', [
    'require',
    './base',
    '../util/shape/Cross',
    'zrender/shape/Line',
    ...
    var Base = echarts.require('./base');
    var CrossShape = echarts.require('../util/shape/Cross');
    var LineShape = echarts.require('zrender/shape/Line');
    var RectangleShape = echarts.require('zrender/shape/Rectangle');
    ...
    var zrColor = echarts.require('zrender/tool/color');
    var zrUtil = echarts.require('zrender/tool/util');
    var zrShapeBase = echarts.require('zrender/shape/Base');
    ...
    echarts.require('../component').define('tooltip', Tooltip);
    return Tooltip;
});echarts.define('echarts/component/legend', [
    'require',
    './base',
    'zrender/shape/Text',
    'zrender/shape/Rectangle',
    ...
    var TextShape = echarts.require('zrender/shape/Text');
    var RectangleShape = echarts.require('zrender/shape/Rectangle');
    var SectorShape = echarts.require('zrender/shape/Sector');
    var IconShape = echarts.require('../util/shape/Icon');
    var CandleShape = echarts.require('../util/shape/Candle');
    var ecConfig = echarts.require('../config');
    var zrUtil = echarts.require('zrender/tool/util');
    var zrArea = echarts.require('zrender/tool/area');
    ...
    echarts.require('../component').define('legend', Legend);
    return Legend;
});echarts.define('echarts/util/ecData', [], function () {
...
});echarts.define('echarts/chart', [], function () {
    var self = {};
    var _chartLibrary = {};
    self.define = function (name, clazz) {
    ...
    return self;
});echarts.define('zrender/tool/color', [
    'require',
    '../tool/util'
], function (require) {
    var util = echarts.require('../tool/util');
...
});echarts.define('echarts/component/timeline', [
    'require',
    './base',
    'zrender/shape/Rectangle',
    '../util/shape/Icon',
    ...
    var RectangleShape = echarts.require('zrender/shape/Rectangle');
    var IconShape = echarts.require('../util/shape/Icon');
    var ChainShape = echarts.require('../util/shape/Chain');
    var ecConfig = echarts.require('../config');
    var zrUtil = echarts.require('zrender/tool/util');
    var zrArea = echarts.require('zrender/tool/area');
    var zrEvent = echarts.require('zrender/tool/event');
    ...
    echarts.require('../component').define('timeline', Timeline);
    return Timeline;
});echarts.define('zrender/shape/Image', [
    'require',
    './Base',
    '../tool/util'
], function (require) {
    ...
    echarts.require('../tool/util').inherits(ZImage, Base);
    return ZImage;
});echarts.define('zrender/loadingEffect/Bar', [
    'require',
    './Base',
    '../tool/util',
    '../tool/color',
    ...
    var Base = echarts.require('./Base');
    var util = echarts.require('../tool/util');
    var zrColor = echarts.require('../tool/color');
    var RectangleShape = echarts.require('../shape/Rectangle');
    ...
    return Bar;
});echarts.define('zrender/loadingEffect/Bubble', [
    'require',
    './Base',
    '../tool/util',
    '../tool/color',
    ...
    var util = echarts.require('../tool/util');
    var zrColor = echarts.require('../tool/color');
    var CircleShape = echarts.require('../shape/Circle');
    ...
    return Bubble;
});echarts.define('zrender/loadingEffect/DynamicLine', [
    'require',
    './Base',
    '../tool/util',
    '../tool/color',
    ...
    var util = echarts.require('../tool/util');
    var zrColor = echarts.require('../tool/color');
    var LineShape = echarts.require('../shape/Line');
    ...
    return DynamicLine;
});echarts.define('zrender/loadingEffect/Ring', [
    'require',
    './Base',
    '../tool/util',
    '../tool/color',
    ...
    var util = echarts.require('../tool/util');
    var zrColor = echarts.require('../tool/color');
    var RingShape = echarts.require('../shape/Ring');
    var SectorShape = echarts.require('../shape/Sector');
    ...
    return Ring;
});echarts.define('zrender/loadingEffect/Spin', [
    'require',
    './Base',
    '../tool/util',
    '../tool/color',
    ...
    var util = echarts.require('../tool/util');
    var zrColor = echarts.require('../tool/color');
    var zrArea = echarts.require('../tool/area');
    var SectorShape = echarts.require('../shape/Sector');
    ...
    return Spin;
});echarts.define('zrender/loadingEffect/Whirling', [
    'require',
    './Base',
    '../tool/util',
    '../tool/area',
    ...
    var zrArea = echarts.require('../tool/area');
    var RingShape = echarts.require('../shape/Ring');
    var DropletShape = echarts.require('../shape/Droplet');
    var CircleShape = echarts.require('../shape/Circle');
    ...
    return Whirling;
});echarts.define('echarts/theme/default', [], function () {
    var config = {};
    return config;
});echarts.define('zrender/dep/excanvas', ['require'], function (require) {
...
});echarts.define('zrender/mixin/Eventful', ['require'], function (require) {
    ...
    return Eventful;
});echarts.define('zrender/tool/log', [
    'require',
    '../config'
], function (require) {
    var config = echarts.require('../config');
    return function () {
...
});echarts.define('zrender/tool/guid', [], function () {
    var idStart = 2311;
    return function () {
        return 'zrender__' + idStart++;
    };
});echarts.define('zrender/Handler', [
    'require',
    './config',
    './tool/env',
    './tool/event',
    ...
    'use strict';
    var config = echarts.require('./config');
    var env = echarts.require('./tool/env');
    var eventTool = echarts.require('./tool/event');
    var util = echarts.require('./tool/util');
    var vec2 = echarts.require('./tool/vector');
    var mat2d = echarts.require('./tool/matrix');
    ...
    return Handler;
});echarts.define('zrender/Painter', [
    'require',
    './config',
    './tool/util',
    './tool/log',
    ...
    var util = echarts.require('./tool/util');
    var log = echarts.require('./tool/log');
    var matrix = echarts.require('./tool/matrix');
    var BaseLoadingEffect = echarts.require('./loadingEffect/Base');
    var Transformable = echarts.require('./mixin/Transformable');
    ...
    Painter.prototype._shapeToImage = function (id, shape, width, height, devicePixelRatio) {
        ...
        var ImageShape = echarts.require('./shape/Image');
    ...
    return Painter;
});echarts.define('zrender/Storage', [
    'require',
    './tool/util',
    './Group'
], function (require) {
    'use strict';
    var util = echarts.require('./tool/util');
    var Group = echarts.require('./Group');
    ...
    return Storage;
});echarts.define('zrender/animation/Animation', [
    'require',
    './Clip',
    '../tool/color',
    '../tool/util',
    ...
    'use strict';
    var Clip = echarts.require('./Clip');
    var color = echarts.require('../tool/color');
    var util = echarts.require('../tool/util');
    var Dispatcher = echarts.require('../tool/event').Dispatcher;
    ...
    return Animation;
});echarts.define('zrender/tool/vector', [], function () {
    ...
    return vector;
});echarts.define('zrender/tool/matrix', [], function () {
    var ArrayCtor = typeof Float32Array === 'undefined' ? Array : Float32Array;
    var matrix = {
        create: function () {
    ...
    return matrix;
});echarts.define('zrender/loadingEffect/Base', [
    'require',
    '../tool/util',
    '../shape/Text',
    '../shape/Rectangle'
    ...
    var util = echarts.require('../tool/util');
    var TextShape = echarts.require('../shape/Text');
    var RectangleShape = echarts.require('../shape/Rectangle');
    ...
    return Base;
});echarts.define('zrender/mixin/Transformable', [
    'require',
    '../tool/matrix',
    '../tool/vector'
], function (require) {
    'use strict';
    var matrix = echarts.require('../tool/matrix');
    var vector = echarts.require('../tool/vector');
    var origin = [
        0,
        0
    ];
...
});echarts.define('zrender/shape/Text', [
    'require',
    '../tool/area',
    './Base',
    '../tool/util'
], function (require) {
    var area = echarts.require('../tool/area');
    var Base = echarts.require('./Base');
    ...
    echarts.require('../tool/util').inherits(Text, Base);
    return Text;
});echarts.define('zrender/shape/Rectangle', [
    'require',
    './Base',
    '../tool/util'
], function (require) {
    ...
    echarts.require('../tool/util').inherits(Rectangle, Base);
    return Rectangle;
});echarts.define('zrender/tool/area', [
    'require',
    './util',
    './curve'
], function (require) {
    'use strict';
    var util = echarts.require('./util');
    var curve = echarts.require('./curve');
    var _ctx;
    var _textWidthCache = {};
...
});echarts.define('zrender/shape/Base', [
    'require',
    '../tool/matrix',
    '../tool/guid',
    '../tool/util',
    ...
    function _fillText(ctx, text, x, y, textFont, textAlign, textBaseline) {
        ...
        text = (text + '').split('\n');
        var lineHeight = echarts.require('../tool/area').getTextHeight('国', textFont);
        switch (textBaseline) {
        case 'top':
            y = rect.y;
            break;
    ...
    Base.prototype.isCover = function (x, y) {
        ...
        if (x >= rect.x && x <= rect.x + rect.width && y >= rect.y && y <= rect.y + rect.height) {
            return echarts.require('../tool/area').isInside(this, this.style, x, y);
        }
        return false;
    };
    ...
    return Base;
});echarts.define('zrender/tool/curve', [
    'require',
    './vector'
], function (require) {
    var vector = echarts.require('./vector');
    'use strict';
    var EPSILON = 0.0001;
    ...
    return Group;
});echarts.define('zrender/animation/Clip', [
    'require',
    './easing'
], function (require) {
    var Easing = echarts.require('./easing');
    ...
    return Clip;
});echarts.define('zrender/animation/easing', [], function () {
    var easing = {
        Linear: function (k) {
            return k;
        },
    ...
    return easing;
});echarts.define('echarts/component/base', [
    'require',
    '../config',
    '../util/ecData',
    '../util/ecQuery',
    ...
    var ecConfig = echarts.require('../config');
    var ecData = echarts.require('../util/ecData');
    var ecQuery = echarts.require('../util/ecQuery');
    var number = echarts.require('../util/number');
    var zrUtil = echarts.require('zrender/tool/util');
    ...
    Base.prototype = {
        canvasSupported: echarts.require('zrender/tool/env').canvasSupported,
    ...
    return Base;
});echarts.define('echarts/chart/base', [
    'require',
    'zrender/shape/Image',
    '../util/shape/Icon',
    '../util/shape/MarkLine',
    ...
    var ImageShape = echarts.require('zrender/shape/Image');
    var IconShape = echarts.require('../util/shape/Icon');
    var MarkLineShape = echarts.require('../util/shape/MarkLine');
    var SymbolShape = echarts.require('../util/shape/Symbol');
    var ecConfig = echarts.require('../config');
    var ecData = echarts.require('../util/ecData');
    var ecAnimation = echarts.require('../util/ecAnimation');
    var ecEffect = echarts.require('../util/ecEffect');
    var accMath = echarts.require('../util/accMath');
    var zrUtil = echarts.require('zrender/tool/util');
    var zrArea = echarts.require('zrender/tool/area');
    function Base() {
    ...
    return Base;
});echarts.define('zrender/shape/Circle', [
    'require',
    './Base',
    '../tool/util'
], function (require) {
    ...
    echarts.require('../tool/util').inherits(Circle, Base);
    return Circle;
});echarts.define('echarts/util/accMath', [], function () {
...
});echarts.define('echarts/util/ecQuery', [
    'require',
    'zrender/tool/util'
], function (require) {
    var zrUtil = echarts.require('zrender/tool/util');
...
});echarts.define('echarts/util/number', [], function () {
    function _trim(str) {
...
});echarts.define('echarts/util/shape/Icon', [
    'require',
    'zrender/tool/util',
    'zrender/shape/Star',
    'zrender/shape/Heart',
    ...
    function _iconStar(ctx, style) {
        var StarShape = echarts.require('zrender/shape/Star');
        var width = style.width / 2;
        var height = style.height / 2;
    ...
    function _iconHeart(ctx, style) {
        var HeartShape = echarts.require('zrender/shape/Heart');
    ...
    function _iconDroplet(ctx, style) {
        var DropletShape = echarts.require('zrender/shape/Droplet');
    ...
    var Base = echarts.require('zrender/shape/Base');
    ...
    return Icon;
});echarts.define('echarts/util/shape/MarkLine', [
    'require',
    'zrender/shape/Base',
    './Icon',
    'zrender/shape/Line',
    ...
    var Base = echarts.require('zrender/shape/Base');
    var IconShape = echarts.require('./Icon');
    var LineShape = echarts.require('zrender/shape/Line');
    var lineInstance = new LineShape({});
    var BrokenLineShape = echarts.require('zrender/shape/BrokenLine');
    var brokenLineInstance = new BrokenLineShape({});
    var matrix = echarts.require('zrender/tool/matrix');
    var area = echarts.require('zrender/tool/area');
    var dashedLineTo = echarts.require('zrender/shape/util/dashedLineTo');
    var smoothSpline = echarts.require('zrender/shape/util/smoothSpline');
    var zrUtil = echarts.require('zrender/tool/util');
    ...
    return MarkLine;
});echarts.define('echarts/util/shape/Symbol', [
    'require',
    'zrender/shape/Base',
    ...
    var Base = echarts.require('zrender/shape/Base');
    var PolygonShape = echarts.require('zrender/shape/Polygon');
    ...
    Symbol.prototype = {
        ...
        isCover: echarts.require('./normalIsCover')
    };
    zrUtil.inherits(Symbol, Base);
    return Symbol;
});echarts.define('echarts/util/ecAnimation', [
    'require',
    'zrender/tool/util',
    'zrender/shape/Polygon'
], function (require) {
    ...
    function polygon(zr, oldShape, newShape, duration, easing) {
        var rect = echarts.require('zrender/shape/Polygon').prototype.getRect(newShape.style);
...
});echarts.define('echarts/util/ecEffect', [
    'require',
    '../util/ecData',
    'zrender/shape/Circle',
    'zrender/shape/Image',
    ...
    var IconShape = echarts.require('../util/shape/Icon');
    var SymbolShape = echarts.require('../util/shape/Symbol');
    var canvasSupported = echarts.require('zrender/tool/env').canvasSupported;
...
});echarts.define('zrender/shape/Star', [
    'require',
    '../tool/math',
    './Base',
    '../tool/util'
], function (require) {
    var math = echarts.require('../tool/math');
    var sin = math.sin;
    var cos = math.cos;
    var PI = Math.PI;
    var Base = echarts.require('./Base');
    ...
    echarts.require('../tool/util').inherits(Star, Base);
    return Star;
});echarts.define('zrender/shape/Heart', [
    'require',
    './Base',
    './util/PathProxy',
    'zrender/tool/area',
    ...
    'use strict';
    var Base = echarts.require('./Base');
    var PathProxy = echarts.require('./util/PathProxy');
    var area = echarts.require('zrender/tool/area');
    ...
    echarts.require('../tool/util').inherits(Heart, Base);
    return Heart;
});echarts.define('zrender/shape/Droplet', [
    'require',
    './Base',
    './util/PathProxy',
    'zrender/tool/area',
    ...
    echarts.require('../tool/util').inherits(Droplet, Base);
    return Droplet;
});echarts.define('zrender/tool/math', [], function () {
...
});echarts.define('zrender/shape/util/PathProxy', [
    'require',
    '../../tool/vector'
], function (require) {
    var vector = echarts.require('../../tool/vector');
    ...
    return PathProxy;
});echarts.define('zrender/shape/Line', [
    'require',
    './Base',
    './util/dashedLineTo',
    '../tool/util'
    ...
    var Base = echarts.require('./Base');
    var dashedLineTo = echarts.require('./util/dashedLineTo');
    ...
    echarts.require('../tool/util').inherits(Line, Base);
    return Line;
});echarts.define('zrender/shape/BrokenLine', [
    'require',
    './Base',
    './util/smoothSpline',
    './util/smoothBezier',
    ...
    var Base = echarts.require('./Base');
    var smoothSpline = echarts.require('./util/smoothSpline');
    var smoothBezier = echarts.require('./util/smoothBezier');
    var dashedLineTo = echarts.require('./util/dashedLineTo');
    ...
    BrokenLine.prototype = {
        ...
        getRect: function (style) {
            return echarts.require('./Polygon').prototype.getRect(style);
        }
    };
    echarts.require('../tool/util').inherits(BrokenLine, Base);
    return BrokenLine;
});echarts.define('zrender/shape/util/dashedLineTo', [], function () {
    var dashPattern = [
        5,
        5
    ];
...
});echarts.define('zrender/shape/util/smoothSpline', [
    'require',
    '../../tool/vector'
], function (require) {
    var vector = echarts.require('../../tool/vector');
...
});echarts.define('zrender/shape/util/smoothBezier', [
    'require',
    '../../tool/vector'
], function (require) {
    var vector = echarts.require('../../tool/vector');
...
});echarts.define('zrender/shape/Polygon', [
    'require',
    './Base',
    './util/smoothSpline',
    './util/smoothBezier',
    ...
    echarts.require('../tool/util').inherits(Polygon, Base);
    return Polygon;
});echarts.define('echarts/util/shape/normalIsCover', [], function () {
    return function (x, y) {
        var originPos = this.getTansform(x, y);
        x = originPos[0];
        y = originPos[1];
...
});echarts.define('echarts/component/dataView', [
    'require',
    './base',
    '../config',
    'zrender/tool/util',
    ...
    echarts.require('../component').define('dataView', DataView);
    return DataView;
});echarts.define('echarts/util/shape/Cross', [
    'require',
    'zrender/shape/Base',
    'zrender/shape/Line',
    'zrender/tool/util',
    ...
    return Cross;
});echarts.define('zrender/shape/Sector', [
    'require',
    '../tool/math',
    ...
    var math = echarts.require('../tool/math');
    var computeBoundingBox = echarts.require('../tool/computeBoundingBox');
    var vec2 = echarts.require('../tool/vector');
    var Base = echarts.require('./Base');
    ...
    echarts.require('../tool/util').inherits(Sector, Base);
    return Sector;
});echarts.define('echarts/util/shape/Candle', [
    'require',
    'zrender/shape/Base',
    'zrender/tool/util',
    './normalIsCover'
    ...
    return Candle;
});echarts.define('zrender/tool/computeBoundingBox', [
    'require',
    './vector',
    './curve'
], function (require) {
    var vec2 = echarts.require('./vector');
    var curve = echarts.require('./curve');
...
});echarts.define('echarts/util/shape/Chain', [
    'require',
    'zrender/shape/Base',
    './Icon',
    'zrender/shape/util/dashedLineTo',
    ...
    return Chain;
});echarts.define('zrender/shape/Ring', [
    'require',
    './Base',
    '../tool/util'
], function (require) {
    ...
    echarts.require('../tool/util').inherits(Ring, Base);
    return Ring;
});echarts.define('echarts/component/axis', [
    'require',
    './base',
    'zrender/shape/Line',
    '../config',
    ...
    Axis.prototype = {
        ...
        refresh: function (newOption) {
            ...
            var CategoryAxis = echarts.require('./categoryAxis');
            var ValueAxis = echarts.require('./valueAxis');
    ...
    echarts.require('../component').define('axis', Axis);
    return Axis;
});echarts.define('echarts/component/grid', [
    'require',
    './base',
    'zrender/shape/Rectangle',
    '../config',
    ...
    echarts.require('../component').define('grid', Grid);
    return Grid;
});echarts.define('echarts/component/dataZoom', [
    'require',
    './base',
    'zrender/shape/Rectangle',
    'zrender/shape/Polygon',
    ...
    var IconShape = echarts.require('../util/shape/Icon');
    var ecConfig = echarts.require('../config');
    var ecDate = echarts.require('../util/date');
    var zrUtil = echarts.require('zrender/tool/util');
    ...
    echarts.require('../component').define('dataZoom', DataZoom);
    return DataZoom;
});echarts.define('echarts/component/categoryAxis', [
    'require',
    './base',
    'zrender/shape/Text',
    'zrender/shape/Line',
    ...
    echarts.require('../component').define('categoryAxis', CategoryAxis);
    return CategoryAxis;
});echarts.define('echarts/component/valueAxis', [
    'require',
    './base',
    'zrender/shape/Text',
    'zrender/shape/Line',
    ...
    ValueAxis.prototype = {
        ...
        _reformValue: function (scale) {
            var smartSteps = echarts.require('../util/smartSteps');
    ...
    echarts.require('../component').define('valueAxis', ValueAxis);
    return ValueAxis;
});echarts.define('echarts/util/date', [], function () {
    var _timeGap = [
        {
            formatter: 'hh : mm : ss',
            value: 1000
...
});echarts.define('echarts/util/smartSteps', [], function () {
    var mySteps = [
        10,
        25,
        50
